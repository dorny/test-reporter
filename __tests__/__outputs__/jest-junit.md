...
**6** tests were completed in **191ms** with **1** passed, **4** failed and **1** skipped.
|Test suite|Passed|Failed|Skipped|Time|
|:---|---:|---:|---:|---:|
|[__tests__/main.test.js](#user-content-r0s0)|1 ✅|3 ❌||114ms|
|[__tests__/second.test.js](#user-content-r0s1)||1 ❌|1 ⚪|41ms|
